...
class FoundryScreen(
    ...
    companion object {
        private val CONTAINER_TEXTURE: Identifier =
            Identifier.withDefaultNamespace("textures/gui/container/blast_furnace.png")
        ...
        private val LAVA_BAR_BG: Identifier =
            Identifier.fromNamespaceAndPath("foundry", "container/foundry/lava_bar_bg")
        private val LAVA_BAR_FILL: Identifier =
            Identifier.fromNamespaceAndPath("foundry", "container/foundry/lava_bar_fill")
    ...
    override fun extractBackground(
        ...
        graphics.blitSprite(
            ...
            xo + 115, yo + 49, 18, 18   // byproduct slot
        )
        graphics.blitSprite(
            RenderPipelines.GUI_TEXTURED,
            Identifier.withDefaultNamespace("container/slot"),
            xo + 150, yo + 58, 18, 18   // lava bucket slot
        )
        ...
        if (menu.isBurning()) {
            ...
            graphics.blitSprite(
                RenderPipelines.GUI_TEXTURED,
                LIT_PROGRESS_SPRITE,
                14, 14,                    // full sprite size
                0, vOff,                   // skip top vOff rows (shrinks from top)
                xo + 57, yo + 36 + vOff,  // screen pos follows the shrink
                14, fireH
            )
        }
        ...
        if (arrowW > 0) {
            graphics.blitSprite(
                ...
                24, 16,          // full sprite size
                0, 0,
                xo + 79, yo + 34,
                arrowW, 16       // partial width from left
            )
        }
